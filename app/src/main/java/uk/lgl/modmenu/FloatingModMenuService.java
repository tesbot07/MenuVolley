...
public class FloatingModMenuService extends Service {
    ...
    private void initFloating() {
        ...
        mExpanded.setLayoutParams(new LinearLayout.LayoutParams(dp(200), dp(250)));
        gdMenuBody = new GradientDrawable();
        gdMenuBody.setCornerRadius(MENU_CORNER); //Set corner
        gdMenuBody.setColor(Color.parseColor(cbv())); //Set background color
        ...
        rlsettings.topMargin = 1;
        rlsettings.bottomMargin = 3;
       ...
       // Switch(1002, "Auto size vertically");
        ...
        title.setText(Html.fromHtml(Title()));
        title.setBackgroundColor(Color.parseColor("#40000000"));
        title.setTextColor(Color.parseColor("#FF0500"));
        title.setTypeface(Typeface.DEFAULT_BOLD);
        title.setTextSize(18.0f);
        title.setShadowLayer(8.0f, 0.0f, 0.0f, Color.parseColor("#FFFFFFFF"));
        ...
        DCCEECC.setStroke(1, Color.parseColor("#FFFFFF"));
        title.setBackground(DCCEECC);
      ...
      //  scrlLLExpanded.weight = 1.0f;
		...
		scrollView.setLayoutParams(new LinearLayout.LayoutParams(-1, dp(160)));
        scrollView.setBackgroundColor(Color.parseColor(cbv()));
	...
	//    patches.setLayoutParams(new LinearLayout.LayoutParams(-1, -1));
       ...
       // patches.setBackgroundColor(MENU_FEATURE_BG_COLOR);
        ...
        closeBtn.setText("Tap Here to Hide");
        closeBtn.setTextColor(Color.parseColor("#32cb00"));
    ...
    private void Switch(final int featureNum, final String featureName) {
		...
		switchR.setText(Html.fromHtml("<font face='monospace'>" + featureName + "</font>"));
        switchR.setTextColor(Color.parseColor("#DEEDF6"));
        switchR.setPadding(20, 20, 20, 20);
    ...
    private void SeekBar(final int featureNum, final String featureName, final int prog, int max) {
      ...
      //  linearLayout.setPadding(10, 5, 0, 5);
        ...
        textView.setText(Html.fromHtml("<font face='monospace'>" + featureName + ": <font color='#41c300'>" + ((loadedProg == -1) ? prog : loadedProg) + "</font>"));
        textView.setTextColor(Color.parseColor("#DEEDF6"));

        SeekBar seekBar = new SeekBar(this);
		seekBar.setBackgroundColor(Color.parseColor("#40000000"));
    //    seekBar.setPadding(25, 10, 35, 10);
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
                ...
                textView.setText(Html.fromHtml("<font face='monospace'>" + featureName + ": <font color='#41c300'>" + (i < prog ? prog : i) + "</font>"));
            }
        });
    ...
    //    button.setPadding(5, 5, 5, 5);
	    button.setBackgroundColor(Color.parseColor("#40000000"));
        button.setTextSize(13.0f);
        button.setTextColor(Color.parseColor("#DEEDF6"));
        button.setGravity(Gravity.CENTER);
        button.setText(Html.fromHtml("<font face='monospace'>" + featureName + "</font>"));
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
    ...
    private void Spinner(final int featureNum, final String featureName, final String list) {
       ...
       // linearLayout.setPadding(10, 5, 10, 5);
		...
		textView.setBackgroundColor(Color.parseColor("#40000000"));
        textView.setText(Html.fromHtml("<font face='monospace'>" + featureName + ": <font color='#41c300'></font>"));
        textView.setTextColor(Color.parseColor("#DEEDF6"));
    ...
    private void RadioButton(final int featureNum, String featureName, final String list) {
		...
		//radioGroup.setBackgroundColor(Color.parseColor("#40000000"));
        ...
        for (int i = 0; i < lists.size(); i++) {
            ...
            View.OnClickListener first_radio_listener = new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    textView.setText(Html.fromHtml("<font face='monospace'>" + finalFeatureName + ": <font color='#41c300'>" + radioName + "</font>"));
			...
			//Radioo.setBackgroundColor(Color.parseColor("#40000000"));
